...
export function TikTokIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden fill="currentColor">
      <path d="M14.5 3h3.1c.2 1.7 1.4 3.1 3.1 3.5v3.1c-1.1-.1-2.1-.5-3-1.1v6.3c0 3.3-2.6 5.9-5.9 5.9S5.9 18.1 5.9 14.8 8.5 8.9 11.8 8.9c.3 0 .6 0 .9.1v3.2c-.3-.1-.6-.2-.9-.2-1.5 0-2.7 1.2-2.7 2.8s1.2 2.8 2.7 2.8 2.7-1.2 2.7-2.8V3z" />
    </svg>
  );
}
