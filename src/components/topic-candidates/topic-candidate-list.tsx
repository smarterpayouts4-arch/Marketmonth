          ...
          return (
            <li key={c.topicId}>
              <button
                ...
                disabled={disabled}
                onClick={() => onSelect(c)}
                data-testid={`${testIdPrefix}-item-${c.rank}`}
                className={cn(
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        ...
                        data-testid={`${testIdPrefix}-provenance-${c.rank}`}
                      >
                      ...
                      {c.titleItchType ? (
                        <span
                          className="text-[10px] text-text-muted"
                          data-testid={`${testIdPrefix}-title-itch-${c.rank}`}
                          title={c.titleHookVersion}
                        >
                          trigger:{c.titleItchType}
                        </span>
                      ) : null}
                    </div>
