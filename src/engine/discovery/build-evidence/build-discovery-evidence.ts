...
import { extractCtas, extractTestimonials } from "./html-scrape";
...
export function buildDiscoveryEvidence(input: {
  ...
  for (const product of signals.indexedProducts.slice(0, 16)) {
  ...
  // Structured FAQs only — never promote bulk faqText into customerProblems.
