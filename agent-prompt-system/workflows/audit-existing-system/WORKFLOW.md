...
description: Findings-first audit with evidence; separate findings from fixes unless asked.
categories:
  - audit
tags:
  - review
...
risk_levels:
  ...
  - high
use_when:
  - User wants a review, gap analysis, or readiness check
  - Need inventory of issues before changes
do_not_use_when:
  - User wants an immediate small fix with known scope
compatible_with:
