...
| /api/discovery/analyze | `src/app/api/discovery/analyze/route.ts` |
| /api/discovery/strategy | `src/app/api/discovery/strategy/route.ts` |
| /api/onboarding/create-plan | `src/app/api/onboarding/create-plan/route.ts` |
| /api/onboarding/workspace-context | `src/app/api/onboarding/workspace-context/route.ts` |
| /api/project-knowledge/ask | `src/app/api/project-knowledge/ask/route.ts` |
| /api/seo/refresh | `src/app/api/seo/refresh/route.ts` |
| /api/seo/status | `src/app/api/seo/status/route.ts` |
